...
namespace COMP003B.Assignment6.Controllers
{
    ...
    {
        private readonly ZachContext _context;

        public ActorsController(ZachContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ActorId,Name,Age")] Actor actor)
        {
