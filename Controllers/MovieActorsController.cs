...
namespace COMP003B.Assignment6.Controllers
{
    public class MovieActorsController : Controller
    {
        ...
        public MovieActorsController(ZachContext context)
        {
            _context = context;
        }
        ...
        {
            var zachContext = _context.MovieActors.Include(m => m.Actor).Include(m => m.Movies);
            return View(await zachContext.ToListAsync());
        }
        ...
        public IActionResult Create()
        {
            ...
            ViewData["MoviesId"] = new SelectList(_context.Moviess, "MoviesId", "Title");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ActorId,MoviesId")] MovieActor movieActor)
        {
            ...
            ViewData["MoviesId"] = new SelectList(_context.Moviess, "MoviesId", "Title", movieActor.MoviesId);
            return View(movieActor);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ActorId,MoviesId")] MovieActor movieActor)
        {
            if (id != movieActor.Id)
            {
                return NotFound();
